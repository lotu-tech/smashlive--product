...
## Affected Projects
- smashlive--backoffice: Add ping monitoring views to arena details page and new summary dashboard
- smashlive--infra: Implement ping collection and reporting from arena devices to AWS
